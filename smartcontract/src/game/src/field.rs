...
use structures::{Direction, Draw, Field, Point, Ship, ShipDirection, Status};
use utils::{convert_to_u8, generate_all_empty_points, random_number};
...
impl GameField {
    ...
    pub fn generate_random_point(&mut self, direction: &ShipDirection, size: u8) -> Point {
        ...
        let allowed_points = empty_points
            ...
            .cloned()
            .collect::<Vec<Point>>();
        let point_index = (random_number)(0, allowed_points.len() as u8);
